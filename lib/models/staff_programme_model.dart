...
class StaffProgrammeModel {
  ...
  factory StaffProgrammeModel.fromJson(Map<String, dynamic> json) {
    return StaffProgrammeModel(
      ...
      programmeName: json['Programme_Name'] ?? json['programme_name'] ?? '',
      programmeDescription: json['Programme_Description'] ?? json['programme_description'],
      startDate: json['Start_Date'] != null ? DateTime.parse(json['Start_Date']) : (json['start_date'] != null ? DateTime.parse(json['start_date']) : null),
      endDate: json['End_Date'] != null ? DateTime.parse(json['End_Date']) : (json['end_date'] != null ? DateTime.parse(json['end_date']) : null),
      capacity: json['Capacity'] ?? json['capacity'],
      programmeStatus: json['Programme_Status'] ?? json['programme_status'] ?? 'draft',
      ...
      programmeCategory: json['Programme_Category'] ?? json['programme_category'],
