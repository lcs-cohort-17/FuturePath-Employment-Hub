...
class Programme {
  ...
  factory Programme.fromJson(Map<String, dynamic> json) {
    return Programme(
      id: json['programme_id']?.toString() ?? json['id']?.toString() ?? '',
      title: json['Programme_Name'] ?? json['title'] ?? json['name'] ?? '',
      provider: json['provider'] ?? '',
      category: json['Programme_Category'] ?? json['category'] ?? '',
      level: json['level'] ?? '',
      ...
      skills: json['Required_Skills'] is List ? List<String>.from(json['Required_Skills']) : List<String>.from(json['skills'] ?? []),
