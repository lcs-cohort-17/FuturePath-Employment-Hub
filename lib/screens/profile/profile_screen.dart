...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ProfileScreenContent(
      // Keep these for the header; the Details tab consumes provider directly.
              ...
              _buildSectionCard(
                ...
                child: Column(
                  children: [
                    ...
                    _buildInfoRow(
                      'Employment Status',
                      '${userProfile.employmentStatus} — Seeking Opportunities',
                    ),
                  ],
                ),
              ),
              ...
              _buildSectionCard(
                ...
                child: Column(
                  children: [
                    ...
                    if (userProfile.cvFileName != null &&
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: (userProfile.skills.isNotEmpty
                              ? userProfile.skills
                              : const [
                                  'Flutter',
                                  'Dart',
