...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ProfileScreenContent(
      ...
      onSignOut: () => _handleLogout(context, authService),
      onNavigateToCV: () {
        Navigator.push(
          context,
  ...
  /// Signs the user out via [AuthService] and clears the navigation stack
  /// so the back button cannot return to a protected screen. On failure,
  /// shows an error message and keeps the user on Profile.
  Future<void> _handleLogout(BuildContext context, dynamic authService) async {
    try {
