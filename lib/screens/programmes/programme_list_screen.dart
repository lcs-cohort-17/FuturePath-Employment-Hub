...
class ProgrammeListScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ProgrammeListScreen> createState() => _ProgrammeListScreenState();
}
...
class _ProgrammeListScreenState extends ConsumerState<ProgrammeListScreen> {
  ...
  List<Programme> get _filteredProgrammes {
    ...
    return widget.programmes.where((programme) {
      ...
      final matchesLocation = filterState.selectedLocations.isEmpty ||
          filterState.selectedLocations.contains(programme.provider);
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Consumer(
        builder: (context, ref, child) {
          final provider = ref.watch(searchFilterProvider);
                  ...
                  Wrap(
                    ...
                    children: _locationFilters.map((location) {
                      ...
                      return _FilterChip(
                        label: location,
                        selected: isSelected,
                        onTap: () => notifier.toggleLocation(location),
                      );
                    }).toList(),
                  ),
                  const SizedBox(height: 24),
                  ...
                  Wrap(
                    ...
                    children: _programmeTypeFilters.map((type) {
                      ...
                      return _FilterChip(
                        label: type,
                        selected: isSelected,
                        onTap: () => notifier.toggleLocation(type),
                      );
                    }).toList(),
                  ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: selected ? AppTheme.accent : Colors.white24),
        ),
        child: Text(
          label,
          style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Expanded(child: _InfoColumn(label: 'Starts', value: programme.startDate)),
                      Expanded(child: _InfoColumn(label: 'Duration', value: programme.duration)),
                      Expanded(
                        child: _InfoColumn(
                          label: 'Spots left',
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          value,
          style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: valueColor ?? AppTheme.textDark),
        ),
      ],
    );
  }
